 ...
 ***************************************************************************************************************************************************************************** 
 */
public class UmeiWebViewActivity extends CommonFragmentActivity {
	private static final String TAG = UmeiWebViewActivity.class.getSimpleName();
	...
	public static void startUmeiWebViewActivity(Context context, String url) {
		...
		intent.setClass(context, UmeiWebViewActivity.class);
