...
import com.open.umei.utils.ExcelUtils;
 ...
 ***************************************************************************************************************************************************************************** 
 */
public class UmeiOpenDBActivity extends CommonFragmentActivity<OpenDBJson> implements OnClickListener, OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_umei_open_db);
		init();
	}
	...
	protected void bindEvent() {
		...
		mPullRefreshListView.setOnRefreshListener(new OnRefreshListener<ListView>() {
			...
			public void onRefresh(PullToRefreshBase<ListView> refreshView) {
				String label = DateUtils.formatDateTime(UmeiOpenDBActivity.this, System.currentTimeMillis(), DateUtils.FORMAT_SHOW_TIME | DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_ABBREV_ALL);
	...
	public void onClick(View v) {
		...
		case R.id.btn_importexcel:
			...
			try {
				...
				UmeiOpenDBService.insertBatch(this, importlist);
				list.clear();
	...
	public void handlerMessage(Message msg) {
		...
		case MESSAGE_ADAPTER_UN_COLLECTION:
			UmeiOpenDBService.delete(this, list.get(msg.arg1));
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		if ((id) != -1 && list != null && list.size() > 0) {
			...
			if(bean!=null){
				switch (bean.getType()) {
				case 1:
					UmeiArticleGridHeadActivity.startUmeiArticleGridHeadActivity(this, bean.getUrl());
					break;
				case 2:
