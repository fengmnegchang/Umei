...
import com.open.umei.fragment.m.UmeiMArcBodyPullListFragment;
 ...
 *****************************************************************************************************************************************************************************
 */
public class UmeiMArcBodyListHeadFootActivity extends CommonFragmentActivity<UmeiMArcBodyJson>{
...
//	private TextView txt_artsee;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_umei_m_arc_body_list_head_foot);
		init();
	}
...
//		txt_artsee = (TextView) findViewById(R.id.txt_artsee);
	...
	protected void initValue() {
		...
		Fragment pullfragment = UmeiMArcBodyPullListFragment.newInstance(url,true);
