...
import com.open.umei.adapter.AllClassAdapter;
import com.open.umei.bean.AllBean;
 ...
 ***************************************************************************************************************************************************************************** 
 */
public class UmeiALLActivity extends CommonFragmentActivity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_umei_all);
		init();
	}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		if (bean != null && !UmeiALLActivity.class.getName().equals(bean.getClassName())) {
