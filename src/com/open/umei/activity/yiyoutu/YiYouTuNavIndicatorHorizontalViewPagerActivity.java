...
import com.open.umei.fragment.yiyoutu.YiYouTuNavIndicatorHorizontalViewPagerFragment;
 ...
 *****************************************************************************************************************************************************************************
 */
public class YiYouTuNavIndicatorHorizontalViewPagerActivity extends CommonFragmentActivity<UmeiNavJson>{
	private String url = UrlUtils.YIYOUTU_M;
	@Override
	...
	protected void initValue() {
		...
		YiYouTuNavIndicatorHorizontalViewPagerFragment fragment = YiYouTuNavIndicatorHorizontalViewPagerFragment.newInstance(url, true);
	...
	public static void startYiYouTuNavIndicatorHorizontalViewPagerActivity(Context mContext, String url ) {
		...
		intent.setClass(mContext, YiYouTuNavIndicatorHorizontalViewPagerActivity.class);
