 ...
 ***************************************************************************************************************************************************************************** 
 */
public class YiYouTuShowImageFragment extends BaseV4Fragment<UmeiArticleJson, YiYouTuShowImageFragment> {
	public String url;
	public int pageNo = 0;
	...
	public static YiYouTuShowImageFragment newInstance(String url, boolean isVisibleToUser) {
		YiYouTuShowImageFragment fragment = new YiYouTuShowImageFragment();
	...
	public UmeiArticleJson call() throws Exception {
		UmeiArticleJson mUmeiArticleJson = YiYouTuArticleService.parseMArticlePagerSize(url, pageNo + 1);
		...
		viewpager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int position) {
				...
				if (bean != null && bean.getSrc() != null && bean.getSrc().length() > 0) {
					...
					doAsync(YiYouTuShowImageFragment.this, YiYouTuShowImageFragment.this, YiYouTuShowImageFragment.this);
				}
