 ...
 ***************************************************************************************************************************************************************************** 
 */
public class UmeiMTagGridHeadFootFragment extends UmeiMHeadFootGirdArticleFragment {
	...
	public static UmeiMTagGridHeadFootFragment newInstance(String url, boolean isVisibleToUser) {
		UmeiMTagGridHeadFootFragment fragment = new UmeiMTagGridHeadFootFragment();
...
//		getChildFragmentManager().beginTransaction().replace(R.id.layout_nav_head_grid, expandfragment).commit();
	...
	public UmeiMPicJson call() throws Exception {
		// TODO Auto-generated method stub
		UmeiMPicJson mUmeiMPicJson = UmeiMPannelHdService.parseMTagPic(url, pageNo);
		mUmeiMPicJson.setExlist(UmeiMPannelHdService.parseTagGrid(url));
