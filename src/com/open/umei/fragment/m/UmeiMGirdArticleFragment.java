 ...
 ***************************************************************************************************************************************************************************** 
 */
public class UmeiMGirdArticleFragment extends BaseV4Fragment<UmeiMPicJson, UmeiMGirdArticleFragment> {
	public String url;
	public PullToRefreshHeadGridView mPullRefreshGirdView;
	private UmeiMPicGridViewAdapter mUmeiMPicGridViewAdapter;
	private List<UmeiMPicBean> list = new ArrayList<UmeiMPicBean>();
	public int pageNo = 1;

	public static UmeiMGirdArticleFragment newInstance(String url, boolean isVisibleToUser) {
		UmeiMGirdArticleFragment fragment = new UmeiMGirdArticleFragment();
	...
	public void bindEvent() {
		...
		mPullRefreshGirdView.setOnRefreshListener(new OnRefreshListener<HeaderGridView>() {
			@Override
