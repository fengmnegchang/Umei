 ...
 *****************************************************************************************************************************************************************************
 */
public class UmeiMainExpandableListAdapter extends CommonExpandableListAdapter<UmeMPannelHdBean, UmeiMPicBean> {

	public UmeiMainExpandableListAdapter(Context mContext, List<UmeMPannelHdBean> list) {
		super(mContext, list);
	}
	...
	public View getChildView(int groupPosition, int childPosition, boolean arg2, View convertView, ViewGroup parent) {
		...
		mChildViewHolder.mUmeiMPicGridViewAdapter = new UmeiMainGridViewAdapter(mContext, mChildViewHolder.list);
...
//					UmeiMTagGridHeadFootActivity.startUmeiMTagGridHeadFootActivity(mContext, mChildViewHolder.listtaglink.get(position).replace("http://www.umei.cc/", "http://m.umei.cc/"));
	...
	public class ChildViewHolder {
		...
		UmeiMainGridViewAdapter mUmeiMPicGridViewAdapter;
