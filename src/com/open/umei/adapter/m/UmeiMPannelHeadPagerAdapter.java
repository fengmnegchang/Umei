 ...
 ***************************************************************************************************************************************************************************** 
 */
public class UmeiMPannelHeadPagerAdapter extends CommonPagerAdapter<UmeiTypeBean> {

	public UmeiMPannelHeadPagerAdapter(Context mContext, List<UmeiTypeBean> list) {
		super(mContext, list);
	}
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		View convertView = LayoutInflater.from(mContext).inflate(R.layout.adapter_umei_m_pannel_head_head, null);
